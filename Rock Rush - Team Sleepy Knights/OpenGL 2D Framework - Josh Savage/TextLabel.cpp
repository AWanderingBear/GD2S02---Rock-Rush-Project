...
TextLabel::TextLabel(std::string text, std::string font){
	...
	program = shaderLoader.CreateShader("Shaders/Vertex/TextVertexShader.vert","Shaders/Fragment/TextFragmentShader.frag");

	glm::mat4 projection = glm::ortho(0.0f, static_cast<GLfloat>(1366), 0.0f, static_cast<GLfloat>(762));
